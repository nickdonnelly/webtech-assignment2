module ApiHelper
  ...
  "If I were running 'The View', I'd fire Rosie O'Donnell. I mean, I'd look at her right in that fat, ugly face of hers, I'd say 'Rosie, you're fired.'"],
      ...
      "other" => ["And where I excel is ridiculous, sickening, work ethic. You know, while the other guy's sleeping? I'm working.",
  ...
  "Disney expects us to believe that Mulan's ingenuity and courage were enough to carry her to military success on an equal basis with her cloddish cohorts."],
      ...
      "none" => ["China always wins, we always lose. We need to win again.",
